...
# 加载训练好的最佳模型
model = YOLO('runs/detect/underwater_v1/weights/best.pt')  # 替换为你的模型路径

# 视频文件路径
video_path = 'D:/code/shuixia_homework/modol_traning/test/YN060013.MP4'  # 替换为你的4K视频路径
...
while cap.isOpened():
    ...
    if len(timing_data['fps_values']) > 1:
        ...
        for i in range(1, min(100, len(timing_data['fps_values']))):
            ...
            cv2.line(metrics_img, (600 - i * 6, y1), (600 - (i + 1) * 6, y2), (0, 255, 0), 2)
